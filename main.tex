...
\begin{figure}[h]
        \centering
        \rotatebox{0}{{\frame{\includegraphics[scale=0.2, trim={15cm 15cm 16cm 21cm},clip]{a.png}}}}
    ...
    \begin{figure}[h]
        \centering
        \rotatebox{0}{\frame{\includegraphics[scale=0.2, trim={16cm 16cm 17cm 18cm},clip]{b.png}}}
